    ...
    def updateRiotAuth():
        ...
        try:
            for proc in getProcessesByNames(["LeagueClientUx.exe"]):
                ...
                print("RIOT_AUTH_PORT_0:     ", os.environ["RIOT_AUTH_PORT_0"])
                print("RIOT_AUTH_PORT_1:     ", os.environ["RIOT_AUTH_PORT_1"])
                print("RIOT_AUTH_TOKEN_0:    ", os.environ["RIOT_AUTH_TOKEN_0"])
                print("RIOT_AUTH_TOKEN_1:    ", os.environ["RIOT_AUTH_TOKEN_1"])
                print("LOL_INSTALL_DIRECTORY:", os.environ["LOL_INSTALL_DIRECTORY"])
